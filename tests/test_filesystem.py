...
@pytest.fixture(scope='session')
def outdir_two_files(tmpdir_factory, fpath_fasta) -> str:
...
@pytest.fixture(scope='session')
def outdir_three_files(tmpdir_factory, fpath_fasta) -> str:
    # Output directory with following files:
    #   `file_combinator_adjacent_contigs.tsv`
    #   `file.1_combinator_adjacent_contigs.tsv`
...
class TestIsFasta:
    ...
    def test_is_fasta_fasta(self, fpath_fasta: str):
    ...
    def test_is_fasta_fasta_gz(self, fpath_fasta_gz: str):
    ...
    def test_is_fasta_fasta_bz2(self, fpath_fasta_bz2: str):
    ...
    def test_is_fasta_fast(self, fpath_fast: str):
...
class TestBnameNoFastaExt:
    ...
    def test_bname_no_fasta_ext_fasta(self, fpath_fasta: str):
    ...
    def test_bname_no_fasta_ext_fa(self, fpath_fa: str):
    ...
    def test_bname_no_fasta_ext_fasta_gz(self, fpath_fasta_gz: str):
    ...
    def test_bname_no_fasta_ext_fa_gz(self, fpath_fa_gz: str):
...
class TestMakeNumberedPrefix:
    ...
    def test_make_numbered_prefix_fasta(self, fpath_fasta: str):
    ...
    def test_make_numbered_prefix_fa(self, fpath_fa: str):
    ...
    def test_make_numbered_prefix_fasta_gz(self, fpath_fasta_gz: str):
    ...
    def test_make_numbered_prefix_fa_gz(self, fpath_fa_gz: str):
